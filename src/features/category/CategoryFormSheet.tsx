/**
 * 分类表单弹层（N-5：从 CategoryManager 拆出）
 */
...
import {
  resolveCategoryIcon, ICON_CHOICES,
...
export default function CategoryFormSheet({ category, defaultType, defaultParent, onClose, onSaved }: {
